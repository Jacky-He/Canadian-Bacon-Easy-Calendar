...
$recipient = "itangdav@gmail.com";  // Please insert your email address (between the quotation marks)

$yourname = "EZCalendar";  // Please insert your name here (between the quotation marks) It will appear as the sender in the thank-you mail.
...
$cfg['Badwordfields'] = 'name, email, message';  //   Names of fields to be checked with the bad word filter - case sensitive!
...
$number_of_characters_name = "50"; // Maximum number of characters for field "Name" (between the quotation marks)
